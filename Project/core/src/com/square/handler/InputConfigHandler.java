 ...
 */
public class InputConfigHandler implements InputProcessor {


    private ConfigScreen configScreen;

    public InputConfigHandler(ConfigScreen cuadradoGame) {
        this.configScreen = cuadradoGame;
    }
    ...
    public boolean keyDown(int keycode) {
        if (keycode == Input.Keys.BACK) {
            ...
            MainMenu.tap++;
            Gdx.app.log("tapconfig", "s" + MainMenu.tap);
            if (MainMenu.tap == 1) {
                ...
                configScreen.getParticlesGame().getCuadradoGame().dispose();
                System.exit(0);
            }
        }
        return false;
